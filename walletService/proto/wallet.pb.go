...
const file_proto_wallet_proto_rawDesc = "" +
	...
	"\n" +
	"account_id\x18\x01 \x01(\x03R\taccountId2\x90\x01\n" +
	"\rWalletService\x12=\n" +
	"\fCreateWallet\x12\x15.wallet.WalletRequest\x1a\x16.wallet.WalletResponse\x12@\n" +
	"\rCreateAccount\x12\x16.wallet.AccountRequest\x1a\x17.wallet.AccountResponseB-Z+newWalletService/walletService/proto;walletb\x06proto3"
...
var file_proto_wallet_proto_depIdxs = []int32{
	...
	1, // 2: wallet.WalletService.CreateWallet:output_type -> wallet.WalletResponse
	3, // 3: wallet.WalletService.CreateAccount:output_type -> wallet.AccountResponse
